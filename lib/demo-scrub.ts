...
export const DEMO_SCRUB_BEATS: DemoScrubBeat[] = [
  ...
  },
  {
    ...
    index: "FLT",
    code: "FLT",
    title: "Roll vessel work up without erasing vessel identity.",
    body: "Fleet views summarize readiness and open work while drill-down preserves the vessel-scoped record.",
    owner: "Technical manager",
    decision: "Where fleet attention is needed before the next review window.",
  ...
  },
  {
    ...
    index: "VSL",
    code: "VSL",
    title: "Vessel contribution with named users — not a shared password.",
    body: "Shipboard users submit evidence and action updates under individual identities into the same ledger shoreside reviews.",
    owner: "Vessel custodian",
    decision: "What to submit, refresh, or escalate from the vessel portal.",
    screen: productProofScreens.vesselPortal,
  },
  {
    id: "package",
    index: "10 PKG",
