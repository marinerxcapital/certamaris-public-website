...
const baseArticles: Omit<Article, "publishedDate" | "publishedLabel">[] = [
  {
    ...
    body: [
      ...
      "Keep a current inventory of computer-based systems and network-connected equipment that matter to safe operation, with ownership for who updates it. MSC.428(98) does not prescribe a particular inventory format, but auditors and ISM reviewers routinely ask what systems are in scope. An inventory that is incomplete, ship-specific without fleet roll-up, or last updated after a major retrofit is a common weak point.",
